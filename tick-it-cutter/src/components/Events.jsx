      ...
      <Container className="mt-5 featured-event">
        {randomEvent && (
          <Card className="p-5 featured-card">
            <Card.Body>
              <Card.Title as="h1" className="display-4 featured-title">Events</Card.Title>
                  ...
                  <Row noGutters="true">
                    ...
                    <Col>
                      <Card.Body>
                        ...
                        <Card.Text className="event-text">Venue: {event.venue.name}</Card.Text>
                        <Card.Text className="event-text">Artists: {event.artists.name}</Card.Text>
                        <Card.Text className="event-text">Price of Entry: {event.entry_fee}</Card.Text>
                      </Card.Body>
                    </Col>
                  </Row>
                </Card>
